...
class TestAimHashTreeMaker(base.TestAimDBBase):
    ...
    def test_update(self):
        ...
        self.maker.update(htree, [bd, subnet], True)
        ...
        bd.vrf_name = 'shared'
        self.maker.update(htree, [bd], True)
    ...
    def test_update_1(self):
        ...
        self.maker.update(htree, [subj], True)
    ...
    def test_delete(self):
        ...
        htree = tree.StructuredHashTree()
        self.maker.update(htree, [bd1, bd2], True)

        self.maker.delete(htree, [bd1], inmem=True)
        ...
        self.maker.delete(htree, [bd2], inmem=True)
