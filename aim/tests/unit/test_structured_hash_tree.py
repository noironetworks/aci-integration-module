...
class TestTreeBuilder(base.TestAimDBBase):
    ...
    def test_missing(self):
        depl = resource.VmmInjectedDeployment(**{'display_name': '',
                                                 ...
                                                 'guid': u'2efb1d02-377e-11e7-ab4d-84b261c279a8',
                                                 'namespace_name': u'kube-system'})
        ctrlr = resource.VMMController(**{'monitored': False,
                                          'name': u'kube',
                                          'domain_name': u'kube',
                                          'domain_type': u'Kubernetes',
                                          'host_or_ip': u'k8s-host',
                                          'mode': u'k8s',
                                          'scope': u'kubernetes',
                                          'root_cont_name': u'kube-cluster',
                                          'display_name': u''})
        stat = status.AciStatus(**{'health_score': 100,
                                   'resource_id': u'nsguw7phlffy7fvqgmtw5bb2jqqtd77b5p4aqduwjqykbpiwdpwq kube-system f8c1c428-377e-11e7-ab4d-84b261c279a8',
                                   'sync_status': u'synced',
                                   'resource_root': u'vmmp-Kubernetes',
                                   'faults': [],
                                   'sync_message': u'',
                                   'id': u'qohmkhkdygqapqlw6m6ugotcgqcspvboxfrelav5qctjmgs3bqca',
                                   'resource_type': u'VMMController'})
        updates = [depl, ctrlr, stat]

        mgr = aim_manager.AimManager()
        mgr.get_by_id = mock.Mock(return_value=ctrlr)
